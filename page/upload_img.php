            ...
            <div id="form_div">
               <table id="employee_table" align=center>
                <tr id="row1">
                   ...
                   <td><input type="number" step="0.01"  name="num[]" placeholder="How many G/KG/ML/L...." required></td>
