 ...
 <div class="row" id="answer_comment_row">
   ...
   <div  class="col l12 m12 s12" id="show_all_comment">
     ...
     <?php
       ...
       $sql_show_all_comment = $conn->query("SELECT a.* , b.* FROM user as a LEFT JOIN comment_recipe as b
         ON a.username = b.username WHERE b.recipe_code = '$product_id' ORDER BY comment_date DESC");
