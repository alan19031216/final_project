...
<!--we have our html form here where new product information will be entered-->
        ...
        <tr>
          <td colspan="2"><a class="waves-effect waves-light btn back-btn">Cancel</a></td>
        </tr>
        <?php
          }
         ?>
...
$(document).on('click', '.back-btn', function(){
  ...
  $('#table_phone').fadeIn('slow');
  $('#total_phone').fadeIn('slow');
    ...
    $.post("php/update_cart.php", $(this).serialize())
        .done(function(data) {
          ...
          $('#page-content').fadeOut('slow', function(){
            $('#page-content').load('cart_show.php', function(){
