<?php
  ...
  try {
      ...
      $sql_history = $conn->query("UPDATE subs_history SET status = 'Inactive' , cancel_date = '$current_time'
         WHERE username = '$username1'");

      $sql = $conn->query("DELETE FROM subscript WHERE username = $username1 AND cancel_code = '$code'");
      if($sql == true){
        // ---------------- SEND MAIL FORM ----------------
        ...
        $subject="Let cook - Cancel subscript success";
              ...
              <div class='col s12 m6'>
                <div class='card blue-grey darken-1'>
                  <div class='card-content white-text center-align'>
                    ...
                    <center>
                    <span class='card-title'><h2>Your cancel has been success</h2></span>
