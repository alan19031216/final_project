...
$verify_code = substr(str_shuffle(str_repeat("0123456789ABCDEFGHIJKLMNOPQRSTUVWXZY", 5)), 0, 5);

try {
  // Insert data into database
  $stmt = $conn->prepare("INSERT INTO temp_members_db(confirm_code, name , email, password)VALUES('$confirm_code', '$username', '$email', '$password')");
  $stmt->execute();
        ...
        <div class='col s12 m6'>
          <div class='card blue-grey darken-1'>
            <div class='card-content white-text center-align'>
              ...
              <p>Hello, your're almoest ready to start enjoying Lets cook.</p>
              <p>Simply click the big green button blew to verify your email addess</p>
              <br>
              <a class='button button1' href='http://localhost/final%20project/final/php/confirmation.php?passkey=$confirm_code'>Click here to confirm</a>
              <br><br>
              </center>
            </div>
          </div>
