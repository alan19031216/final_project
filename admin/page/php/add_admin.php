...
try {
  ...
  if($sql == true && $sql_login == true){
    ...
    $subject="Let cook Admin password";
          ...
          <div class='col s12 m6'>
            <div class='card blue-grey darken-1'>
              <div class='card-content white-text center-align'>
                ...
                <p>Hello, your're almoest ready start to join Lets cook.</p>
                <p>Simply click the big green button blew to enter you password</p>
                <br>
                <a class='button button1' href='http://localhost/final%20project/final/admin/page/confirm_password.php?code=$code'>Click here to confirm</a>
                <br><br>
                </center>
              </div>
            </div>
